...
<body>
    ...
    <div class="container centrado">
        <div class="row">
            <div class="col">
                <img class="logo" src="assets/images/isologo-ramjav-v4.png" alt="">
                <h1>BIENVENIDOS A LA TIENDA RAMJAV</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <a href="usuarios/acceder.php"><button type="button" class="btn">INICIAR SESI&Oacute;N</button></a>
            </div>
        </div>
